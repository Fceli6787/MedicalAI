  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-teal-50 to-white dark:from-gray-900 dark:to-gray-800">
        ...
        <Image
          ...
          <div className="space-y-6">
            <div className="flex items-center text-white">
              <div className="bg-teal-500 dark:bg-teal-600 p-2 rounded-full mr-3">
                <FileText size={20} />
              </div>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-4 md:p-8">
        <Card className="w-full max-w-md border-none shadow-xl bg-white dark:bg-gray-800">
          <CardHeader className="pb-2">
            <div className="flex justify-between items-center mb-2">
              <div className="flex items-center md:hidden">
                ...
                />
                <span className="font-bold text-teal-600 dark:text-teal-400">SOFIA AI Medical</span>
              </div>
              <div className="flex gap-2">
                <Link href="/login">
                  <Button variant="outline" size="sm" className="text-teal-600 dark:text-teal-400 border-teal-600 dark:border-teal-400">
                    Iniciar Sesión
                  </Button>
                </Link>
              </div>
            ...
            <CardTitle className="text-2xl font-bold text-gray-800 dark:text-white">Registro de Médico</CardTitle>
          ...
          <CardContent className="pt-4">
            <form onSubmit={handleSubmit}>
              {error && (
                <div className="rounded-md bg-red-50 dark:bg-red-900/30 p-3 text-sm text-red-600 dark:text-red-300 mb-4">{error}</div>
              )}
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="personal" className="space-y-4 mt-0">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2 col-span-2 sm:col-span-1">
                      <Label htmlFor="tipoDocumentoCodigo" className="text-gray-700 dark:text-gray-300">
                        Tipo de Documento
                      </Label>
                      <Select
                    ...
                    <div className="space-y-2 col-span-2 sm:col-span-1">
                      <Label htmlFor="nui" className="text-gray-700 dark:text-gray-300">NUI</Label>
                      <Input
                        type="text"
                        id="nui"
                        value={formData.nui}
                        onChange={handleChange}
                        className="bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 dark:text-white"
                        required
                      />
                    </div>

                    <div className="space-y-2 col-span-2 sm:col-span-1">
                      <Label htmlFor="primer_nombre" className="text-gray-700 dark:text-gray-300">Primer Nombre</Label>
                      <Input
                        type="text"
                        id="primer_nombre"
                    ...
                    <div className="space-y-2 col-span-2 sm:col-span-1">
                      <Label htmlFor="segundo_nombre" className="text-gray-700 dark:text-gray-300">Segundo Nombre</Label>
                      <Input
                        type="text"
                        id="segundo_nombre"
                    ...
                    <div className="space-y-2 col-span-2 sm:col-span-1">
                      <Label htmlFor="primer_apellido" className="text-gray-700 dark:text-gray-300">Primer Apellido</Label>
                      <Input
                        type="text"
                        id="primer_apellido"
                    ...
                    <div className="space-y-2 col-span-2 sm:col-span-1">
                      <Label htmlFor="segundo_apellido" className="text-gray-700 dark:text-gray-300">Segundo Apellido</Label>
                      <Input
                        type="text"
                        id="segundo_apellido"
                    ...
                    <div className="space-y-2 col-span-2">
                      <Label htmlFor="paisCodigo" className="text-gray-700 dark:text-gray-300">País</Label>
                      <Select
                  ...
                  <div className="pt-4 flex justify-end">
                    <Button
                      type="button"
                      onClick={goToNextTab}
                      className="bg-teal-600 hover:bg-teal-700 dark:bg-teal-700 dark:hover:bg-teal-600 text-white"
                    >
                      Siguiente
                ...
                <TabsContent value="account" className="space-y-4 mt-0">
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-gray-700 dark:text-gray-300">
                      <div className="flex items-center">
                        <Mail className="h-4 w-4 mr-2 text-teal-600 dark:text-teal-400" />
                        Correo Electrónico
                      </div>
                    </Label>
                    <Input
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="password" className="text-gray-700 dark:text-gray-300">
                      <div className="flex items-center">
                        <Lock className="h-4 w-4 mr-2 text-teal-600 dark:text-teal-400" />
                        Contraseña
                      </div>
                    </Label>
                    <div className="relative">
                      ...
                      <button
                        type="button"
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400"
                  ...
                  <div className="pt-4 flex justify-between">
                    <Button
                      ...
                      onClick={goToPrevTab}
                      variant="outline"
                      className="border-teal-600 dark:border-teal-400 text-teal-600 dark:text-teal-400"
                    >
                      Atrás
                    </Button>
                    <Button
                ...
                <TabsContent value="professional" className="space-y-4 mt-0">
                  <div className="space-y-2">
                    <Label htmlFor="id_especialidad" className="text-gray-700 dark:text-gray-300">
                      <div className="flex items-center">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="numero_tarjeta_profesional" className="text-gray-700 dark:text-gray-300">
                      <div className="flex items-center">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="años_experiencia" className="text-gray-700 dark:text-gray-300">
                      <div className="flex items-center">
                  ...
                  <div className="pt-4 flex flex-col space-y-4">
                    ...
                    <p className="text-xs text-center text-gray-500 dark:text-gray-400 mt-4">
                      Al registrarte aceptas nuestros <a href="#" className="text-teal-600 dark:text-teal-400 hover:underline">Términos y Condiciones</a> y <a href="#" className="text-teal-600 dark:text-teal-400 hover:underline">Política de Privacidad</a>.
                    </p>
                  </div>
                </TabsContent>
              </Tabs>
